...
class DatabaseConnection {
    ...
    async connect() {
        if (this.isConnected) {
            return {
                third_party_db: this.third_party_db,
                posts_db: this.posts_db,
                users_db: this.users_db,
                events_db: this.events_db
            };
        }
...
const { third_party_db, posts_db, users_db, events_db } = await dbConnection.connect();

// Export database instances and connection checker
export { third_party_db, posts_db, users_db, events_db };
